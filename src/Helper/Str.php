 ...
 *
 * @author      BUROQ <admin@buroq.app>
 * @version     1.0
 * @link        https://github.com/ransrue/php-helper
 * @license     MIT
 *
 */

namespace BUROQ\Helper;

/**
 * Helper class that provides easy access to useful php string functions.
 *
 * Class Str
 * @package BUROQ\Helper
 */
class Str
{
    /**
     ...
     */
    public static function afterLast($string, $search)
    {
